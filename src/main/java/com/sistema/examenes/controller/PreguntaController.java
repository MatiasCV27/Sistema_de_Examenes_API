...
public class PreguntaController {
    ...
    private ResponseEntity<?> listarPreguntasDelExamen(@PathVariable("examenId") Long examenId) {
    ...
    private void eliminarPregunta(@PathVariable("preguntaId") Long preguntaId) {
    ...
    public ResponseEntity<?> evaluarExamen(@RequestBody List<Pregunta> preguntas) {
        ...
        respuestas.put("puntosMaximos", puntoMaximos);
